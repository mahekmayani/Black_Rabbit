...
const Profile = () => {
  ...
  const getProfileDta = () => {
    ...
    axios
      .get("http://localhost:3000/api/v1/users/me", { headers })
      .then((res) => {
              ...
              <div class='card'>
                <div class='card-body'>
                  <div class='d-flex flex-column align-items-center text-center'>
                    <img
                      src={imagePreview ? imagePreview : `http://localhost:3000${profileData?.profilePicture}`}
                      alt='Preview'
                  ...
                  <div class='card-body mt-2'>
                    ...
                    <div style={{ display: "flex" }}>
                      ...
                      <p
                        ...
                        // }}
                      >
                        <span className='Cancel-btn' onClick={()=> navigate('/game')}>Cancel</span>
                      </p>
                    </div>
                  </div>
                </div>
